export default function Contact(){
  ...
  <div className="container px-6 py-12 mx-auto mt-2">
    <div className="text-center">
      <p className="font-medium text-gray-500 ">Contact us</p>
      <h1 className="mt-4 text-3xl font-bold text-gray-900 md:text-3xl">
        Get in touch
      </h1>
    ...
    <div className="grid grid-cols-1 gap-12 mt-20 mb-6 md:grid-cols-2 lg:grid-cols-3">
